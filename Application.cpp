...
Application::Application(const AppSettings& appSettings) : m_Settings(appSettings)
{
	Init();
}
...
void Application::Init()
{
    ...
    m_WindowHandle = glfwCreateWindow(m_Settings.Width, m_Settings.Height, m_Settings.Name.c_str(), NULL, NULL);
